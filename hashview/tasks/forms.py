...
class TasksForm(FlaskForm):
    name = StringField('Name', validators=([DataRequired(), db_length(Tasks, 'name')]))
    ...
    j_rule = StringField('-j rule (i.e. $-)', validators=[db_length(Tasks, 'j_rule')])
    k_rule = StringField('-k rule (i.e. $!)', validators=[db_length(Tasks, 'k_rule')])
    mask = StringField('Hashcat Mask', validators=[db_length(Tasks, 'hc_mask')])
